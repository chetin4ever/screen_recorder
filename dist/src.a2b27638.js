...
function _startRecording() {
  _startRecording = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            // record stream
            recorder = new MediaRecorder(stream); // pushing continous data into chuks array
            ...
            recorder.onstop = function (e) {
              var completeBlob = new Blob(chunks, {
                type: chunks[0].type
              });
